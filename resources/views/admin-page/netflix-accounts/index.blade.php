...
<div class="space-y-5">
    ...
    <div class="rounded-2xl bg-white border border-slate-100 shadow-sm p-5">
        ...
        <div class="import-zone mt-5 p-4">
            <div class="flex items-start gap-3 mb-3">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-xs text-slate-400">Format kolom: <span class="font-mono text-slate-500 text-[11px]">email, password, tanggal_reset, tipe_sharing, deskripsi</span></p>
                </div>
            </div>
        ...
        {{-- Filter --}}
        <form action="{{ route('admin.netflix-accounts.index') }}" method="GET" class="mt-4">
            <div class="flex flex-col gap-2 xl:flex-row">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.netflix-accounts.index') }}" class="btn-outline">Reset</a>
                </div>
            </div>
        </form>
    </div>
        ...
        @forelse ($netflixAccounts as $item)
            <div class="data-card rounded-2xl bg-white border border-slate-100 p-4 shadow-sm">
                ...
                <div class="mt-3 grid grid-cols-2 gap-x-4 gap-y-2.5">
                    ...
                    <div>
                        <p class="text-[10px] font-medium text-slate-400 uppercase tracking-wide">Tipe Sharing</p>
                        <p class="mt-1 font-medium text-slate-700 text-xs">{{ $item->tipe_sharing ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-medium text-slate-400 uppercase tracking-wide">Tanggal Reset</p>
            ...
            <table class="min-w-full text-sm">
                <thead>
                    <tr style="background:#fafbff;border-bottom:1.5px solid #f1f5f9;">
                        ...
                        <th class="px-4 py-3.5 text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest">Tgl Reset</th>
                        <th class="px-4 py-3.5 text-left text-[10px] font-bold text-slate-400 uppercase tracking-widest">Tipe</th>
