    ...
    <div class="space-y-5">
        ...
        <div class="rounded-2xl bg-white border border-slate-100 shadow-sm p-5">
            ...
            <div class="mt-5 rounded-xl border border-dashed border-slate-200 bg-slate-50 p-4">
                ...
                <p class="mt-0.5 text-xs text-slate-400">Format: email, password, tanggal_reset, tipe_sharing, deskripsi
                </p>
                ...
                <div class="rounded-2xl bg-white border border-slate-100 p-4 shadow-sm">
                    <div class="flex items-start justify-between gap-3">
                        <div class="min-w-0">
                            ...
                            <p class="text-xs text-slate-400 mt-0.5">#{{ $netflixAccounts->firstItem() + $loop->index }}
                            </p>
                        </div>
                        <span
                            class="shrink-0 inline-flex rounded-full px-2.5 py-1 text-xs font-medium {{ $item->status_reset['class'] }}">
                ...
                <table class="min-w-full text-sm">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-100">
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold text-slate-500">Tgl Reset</th>
                            <th class="px-4 py-3 text-left text-xs font-semibold text-slate-500">Tipe</th>
                        ...
                        @forelse ($netflixAccounts as $item)
                            <tr class="hover:bg-slate-50/70 transition-colors">
                                <td class="px-4 py-3 text-slate-400 text-xs">
                                    {{ $netflixAccounts->firstItem() + $loop->index }}</td>
                                ...
                                <td class="px-4 py-3">
                                    <span
                                        class="inline-flex rounded-full px-2.5 py-1 text-xs font-medium {{ $item->status_reset['class'] }}">
                                        {{ $item->status_reset['label'] }}
                                    </span>
                                </td>
